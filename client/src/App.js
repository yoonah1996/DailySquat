      ...
      <div>
        ...
        <Switch>
          ...
          <Route exact path="/Home" render={(...routeProps) => {
            if (isLogin) {
              return <Home isLogin={this.state.isLogin} selectExercise={this.selectExercise} getUserInfo={this.getUserInfo.bind(this)} /* getTotalCount={this.getTotalCount.bind(this)} */ />
            }
            return <Login isLogin={isLogin} handleIsLogin={handleIsLogin} {...routeProps} />
          }} />
          ...
          <Route exact path="/Mypage" render={(...routeProps) => {
            if (isLogin) {
              return <Mypage userInfo={JSON.stringify(this.state.userInfo)} /* totalCount={this.state.totalCount} */ handleSignOut={this.handleSignOut.bind(this)} isLogin={this.state.isLogin} />
            }
            return <Login isLogin={isLogin} handleIsLogin={handleIsLogin} {...routeProps} />
          }} />

          <Route exact path="/Start" render={(...routeProps) => {
            if (isLogin) {
              return <Start selectCount={this.selectCount.bind(this)} selectedCount={this.state.selectCount} />
            }
            return <Login isLogin={isLogin} handleIsLogin={handleIsLogin} {...routeProps} />
          }} />

          <Route exact path="/Ing" render={(...routeProps) => {
            if (isLogin) {
              return <Ing handleCounting={this.handleCounting.bind(this)} selectCount={this.state.selectCount} exercise={this.state.exercise} />
            }
            return <Login isLogin={isLogin} handleIsLogin={handleIsLogin} {...routeProps} />
          }} />
          ...
          <Route exact path="/Result" render={(...routeProps) => {
            if (isLogin) {
              return <Result count={this.state.count} />
            }
            return <Login isLogin={isLogin} handleIsLogin={handleIsLogin} {...routeProps} />
